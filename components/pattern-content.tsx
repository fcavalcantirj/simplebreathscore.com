    ...
    >
      ...
      <div className="w-full max-w-4xl px-4 py-8">
        ...
        <div className="bg-white/70 dark:bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-200/50 dark:border-slate-700/50 shadow-xl transition-all duration-300 hover:shadow-blue-100 dark:hover:shadow-blue-900/20">
          <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-200 mb-2 text-center">The One Minute Breath</h1>
          <p className="text-center text-slate-600 dark:text-slate-400 mb-6">A Powerful Kundalini Yoga Breathing Technique for Expanded Consciousness</p>
